...
namespace AnBo.Core
{
	...
	public sealed class Crc32Helper
    {
        ...
        private static uint[] m_Crc32Array = // Crc polynomial 0xedb88320 
			{
        ...
        {
            return (m_Crc32Array[((crc) ^ (octet)) & 0xFF] ^ ((crc) >> 8));
        }
        ...
        public uint AddToCrc32(ushort c)
        {
            ...
            m_Crc32 = Update(hiByte, m_Crc32);
            m_Crc32 = Update(lowByte, m_Crc32);
            return ~m_Crc32;
        }
        ...
        /// <returns>The computed checksum.</returns>
        /// <exception cref="ArgNullException">Is thrown if <paramref name="filePath"/> is <see langword="null"/>.</exception>
