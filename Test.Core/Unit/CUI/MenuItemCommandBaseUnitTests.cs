//--------------------------------------------------------------------------
// File:    MenuItemCommandBaseUnitTests.cs
// Content: Unit tests for MenuItemCommandBase class
...
/// </summary>
[Trait("Category", "Unit")]
public class MenuItemCommandBaseUnitTests
{
    /// <summary>
    ...
    /// </summary>
    public MenuItemCommandBaseUnitTests()
    {
